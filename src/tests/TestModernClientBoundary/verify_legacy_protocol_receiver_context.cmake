			...
			elseif(character STREQUAL "[")
				...
				if(bracket_open)
					...
					if(NOT bracket_close_index EQUAL -1)
						...
						set(bracket_argument_sources "${bracket_argument_contents}")
						foreach(bracket_argument_source IN LISTS bracket_argument_sources)
							list(FIND ARGN "${bracket_argument_source}" bracket_receiver_source_index)
